...
int get_boundary_nodes(const int *EToV, const int *neighbors, int **boundary_nodes, int num_nodes, int num_elements);
int get_mesh_degrees(const int *EToV, int **degree, int *num_edges,
		     const int num_elements, const int num_nodes);
int tri_mesh_csr_adj_matrix(csr **adj_matrix, int **boundary_nodes, int *num_boundary_nodes, const int *EToV,
